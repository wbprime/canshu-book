 ...
 * @since 1.0.0
 */
public class Visitors_ForOptionalDouble_Spec extends Specification {
    @Shared
    Visitor<OptionalDouble> visitor = Visitors.forOptionalDouble()
    ...
    def "test from boolean"() {
        ...
        if (has) {
            ...
            assert opt.get().getAsDouble() == (double) r
        } else {
            assert !opt.isPresent()
        }
    ...
    def "test from double"() {
        ...
        Double.POSITIVE_INFINITY       | true | Double.POSITIVE_INFINITY
        Double.NEGATIVE_INFINITY       | true | Double.NEGATIVE_INFINITY
    ...
    def "test from string"() {
        ...
        String.valueOf(Double.POSITIVE_INFINITY) | true  | Double.POSITIVE_INFINITY
        String.valueOf(Double.NEGATIVE_INFINITY) | true  | Double.NEGATIVE_INFINITY
        String.valueOf(Double.NaN)               | true  | Double.NaN
