 ...
 * @since 1.0.0
 */
public class Visitors_ForOptionalInt_Spec extends Specification {
    @Shared
    Visitor<OptionalInt> visitor = Visitors.forOptionalInt()
    ...
    def "test from long"() {
        ...
        1L + Integer.MAX_VALUE  | false | 0
        -1L + Integer.MIN_VALUE | false | 0
    ...
    def "test from double"() {
        ...
        Double.valueOf(Long.MAX_VALUE) | false | 0
        Double.valueOf(Long.MIN_VALUE) | false | 0
    }
    ...
    def "test from string"() {
        ...
        String.valueOf(1L + Integer.MAX_VALUE)   | false | 0
        String.valueOf(-1L + Integer.MIN_VALUE)  | false | 0
        String.valueOf(Long.MAX_VALUE)           | false | 0
        String.valueOf(Long.MIN_VALUE)           | false | 0
        "1.0"                                    | true  | 1
        "0.0"                                    | true  | 0
        "-1.0"                                   | true  | -1
        "0.1"                                    | false | 0
